 ...
 */
final class Version20241014203813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `manga` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, start_date INT NOT NULL, status VARCHAR(255) DEFAULT NULL, volumes_number INT DEFAULT NULL, genres JSON NOT NULL, description LONGTEXT NOT NULL, UNIQUE INDEX unique_author_name (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
